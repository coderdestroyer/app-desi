...
<head>
    ...
    <title>@yield('title', 'Operator') | DPMPTSP Sumatera Utara</title>
                ...
                <ul class="list-none m-0 p-0">
                    ...
                    <li class="mb-[5px]" x-data="{ open: {{ $isPdrbGroupActive ? 'true' : 'false' }} }">
                        <button type="button" @click="open = !open"
                            class="w-full group min-h-[50px] flex items-center justify-between py-3 px-[15px] rounded-[10px] text-white/90 no-underline text-sm font-medium transition-[background,color] duration-[180ms] ease-in-out hover:text-white hover:bg-white/[0.09] {{ $isPdrbGroupActive ? 'bg-white/10 text-white font-semibold' : '' }}">
                            <div class="flex items-center gap-3.5">
                                <i class="fa-solid fa-coins w-[21px] text-[#ffd457] text-center text-[17px]"></i>
                    ...
                    <li class="mb-[5px]">
                        <a href="{{ route('operator.pdb-nasional.index') }}" class="group min-h-[50px] flex items-center gap-3.5 py-3 px-[15px] rounded-[10px] text-white/90 no-underline text-sm font-medium transition-[background,color,transform] duration-[180ms] ease-in-out hover:text-white hover:bg-white/[0.09] hover:translate-x-[2px] [&.active]:text-[#176541] [&.active]:bg-[#ffd457] [&.active]:shadow-[0_10px_22px_rgba(0,0,0,0.11)] {{ request()->routeIs('operator.pdb-nasional.*') ? 'active' : '' }}">
                            <i class="fa-solid fa-globe w-[21px] text-white/[0.76] text-center text-[17px] transition-colors duration-[180ms] group-hover:text-white group-[.active]:text-[#176541]"></i>
