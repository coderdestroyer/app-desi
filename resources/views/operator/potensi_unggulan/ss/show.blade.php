...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <a href="{{ route('operator.ss.index') }}" class="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-white border border-slate-200 text-slate-700 hover:bg-slate-50 font-bold text-xs md:text-sm transition-all shadow-xs">
