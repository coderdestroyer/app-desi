            ...
            <section class="mt-5 flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
                ...
                <div class="flex flex-wrap items-center gap-2">
                    @if ($dataHsCode->onFirstPage())
                        <span
                            class="inline-flex h-9 items-center gap-2 rounded-lg border border-slate-200 bg-slate-100 px-3 text-xs font-semibold text-slate-400">
                            <i class="fa-solid fa-chevron-left"></i>
                            Prev
                        </span>
                    @else
                        <a href="{{ $dataHsCode->previousPageUrl() }}"
                    ...
                    @foreach ($pages as $page)
                        ...
                        @if ($page === $currentPage)
                            <span
                                class="inline-flex h-9 min-w-9 items-center justify-center rounded-lg border border-[#FFD54F] bg-[#FFD54F] px-3 text-xs font-bold text-emerald-900">
                                {{ $page }}
                            </span>
                        @else
                            <a href="{{ $dataHsCode->url($page) }}"
